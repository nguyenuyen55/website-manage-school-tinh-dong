...
public class BaiGiangController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<BaiGiang>> getALlBaiGiangByMonHocAndTen(@RequestParam(value = "idmon", required = false) String idMon, @RequestParam(value = "idchuong", required = false) Integer idchuong, @RequestParam(value = "name", required = false) String name) {
