...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/api/exportPdf/*").permitAll()
                ...
                .antMatchers(HttpMethod.PUT, "/api/change-password").permitAll()
                ...
                .antMatchers(HttpMethod.POST, "/api/tb/update").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/tb/create/*").hasRole("ADMIN")
                ...
                .antMatchers(HttpMethod.GET, "/api/diem").hasRole("STUDENT")
                .antMatchers(HttpMethod.PUT, "/api/diem/hocSinh").hasAnyRole("TEACHER","ADMIN")
                .antMatchers(HttpMethod.POST, "/api/questions/create").permitAll()
                .antMatchers(HttpMethod.GET, "/api/questions/chude").permitAll()
                .antMatchers(HttpMethod.GET, "/api/namhocs").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/student/listbyidlop/*").hasAnyRole("ADMIN","TEACHER")
                ...
                .antMatchers(HttpMethod.GET, "/api/lop/listlop/thoikhoabieu").permitAll()
